...
namespace IBSampleApp
{
    partial class IBSampleAppDialog : Form
    {
        ...
        {
			Console.WriteLine("TickSizeMessage: " + msg.ToString());
        ...
        {
			//MessageBox.Show("aad_aad: " + msg.ToString());
			Console.WriteLine("TickPriceMessage. tick type: " + TickType.getField(msg.Field) + " price: " +  msg.Price);
        ...
        {
			MessageBox.Show("Market data type message");
